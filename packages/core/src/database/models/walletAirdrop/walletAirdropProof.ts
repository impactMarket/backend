...
export class WalletAirdropProofModel extends Model<
    WalletAirdropProof,
    WalletAirdropProofCreationAttributes
> {
    public id!: number;
...
export function initializeWalletAirdropProof(
    sequelize: Sequelize
): typeof WalletAirdropProofModel {
