...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        const Manager = await queryInterface.sequelize.define('manager', {
            id: {
                type: Sequelize.INTEGER,
                autoIncrement: true,
                primaryKey: true
        ...
        const inactive = await Beneficiary.findAll({
            attributes: [
                'communityId',
                [queryInterface.sequelize.fn('count', queryInterface.sequelize.col('address')), 'total']
            ],
            where: {
                active: false
            },
        ...
        const managers = await Manager.findAll({
            attributes: [
                'communityId',
                [queryInterface.sequelize.fn('count', queryInterface.sequelize.col('user')), 'total']
            ],
            group: ['communityId'],
            raw: true,
        });
