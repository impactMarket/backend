...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        for (let index = 0; index < allInflow.length; index++) {
            ...
            await GlobalDailyState.update({ raised: e.a }, { where: { date: e.d } });
        }
        ...
        for (let index = 0; index < allClaim.length; index++) {
            ...
            await GlobalDailyState.update({ claimed: e.a, claims: e.c }, { where: { date: e.d } });
        }
        ...
        for (let index = 0; index < allBeneficiary.length; index++) {
            ...
            await GlobalDailyState.update({ beneficiaries: e.a }, { where: { date: e.d } });
        }
        ...
        for (let index = 0; index < allGlobalDailyState.length; index++) {
            ...
            totalDistributed = new BigNumber(totalDistributed).plus(e.claimed).toString();
            totalBeneficiaries += e.beneficiaries;
            await GlobalDailyState.update({ totalRaised, totalDistributed, totalBeneficiaries }, { where: { date: e.date } });
        }
    },
