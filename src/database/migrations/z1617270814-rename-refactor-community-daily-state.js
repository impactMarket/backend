...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        await queryInterface.removeConstraint(
            'communitydailystate',
            'communitydailystate_communityId_fkey'
        );
        await queryInterface.removeConstraint(
            'communitydailystate',
            'communitydailystate_pkey'
        );
        ...
        for (const community in ids) {
            ...
            await queryInterface.sequelize.query(
                `update ubi_community_daily_state set "communityId"=${parseInt(
                    element.id,
                    10
        ...
        await queryInterface.sequelize.query(
            'alter table ubi_community_daily_state alter column "communityId" drop default;'
        );
