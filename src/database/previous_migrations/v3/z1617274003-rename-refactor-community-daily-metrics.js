...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        await queryInterface.removeConstraint(
            'communitydailymetrics',
            'communitydailymetrics_communityId_fkey'
        );
        await queryInterface.removeConstraint(
            'communitydailymetrics',
            'communitydailymetrics_pkey'
        );
        ...
        for (const community in ids) {
            ...
            await queryInterface.sequelize.query(
                `update ubi_community_daily_metrics set "communityId"=${parseInt(
                    element.id,
                    10
        ...
        await queryInterface.sequelize.query(
            'alter table ubi_community_daily_metrics alter column "communityId" drop default;'
        );
